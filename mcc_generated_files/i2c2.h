...
extern "C" {
    ...
    void DRV_I2C2_MasterWrite(
            ...
            uint8_t length,
            uint16_t address,
            DRV_I2C2_MESSAGE_STATUS *pstatus) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C2_MasterWrite instead. ")));
    ...
    void DRV_I2C2_MasterTRBInsert(
            uint8_t count,
            DRV_I2C2_TRANSACTION_REQUEST_BLOCK *ptrb_list,
            DRV_I2C2_MESSAGE_STATUS *pflag) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C2_MasterTRBInsert instead. ")));
    ...
    void DRV_I2C2_MasterWriteTRBBuild(
            ...
            uint8_t *pdata,
            uint8_t length,
            uint16_t address) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C2_MasterWriteTRBBuild instead. ")));
     ...
     */
    bool DRV_I2C2_MasterQueueIsEmpty(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C2_MasterQueueIsEmpty instead. ")));
     ...
     */
    bool DRV_I2C2_MasterQueueIsFull(void) __attribute__((deprecated("\nThis will be removed in future MCC releases. \nUse I2C2_MasterQueueIsFull instead. ")));
