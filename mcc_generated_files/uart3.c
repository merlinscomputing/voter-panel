...
char U3RXinputBuffer[128]="";
char U3RXOutputBuffer[128]="";
int in3BufferCount=0;
int Rx3BufferReady;
...
#define UART3_CONFIG_TX_BYTEQ_LENGTH 24
#define UART3_CONFIG_RX_BYTEQ_LENGTH 24
...
void UART3_Initialize(void) {
    ...
    U3STA = 0x0000;
    // U3TXREG disabled; LAST disabled; 
    U3TXREG = 0x0000;
    // U3RXREG disabled; 
    U3RXREG = 0x0000;
    //U3BRG = 0x3414; //300
 ...
 while (U3STAbits.URXDA == 1)
   {
    ...
    //while(U3RXREG != '\0') 
    //{
    U3RXinputBuffer[in3BufferCount] = U3RXREG;

    if(U3RXinputBuffer[in3BufferCount]==13) //if /r (CR) return/enter is pressed
        { 
        //strcpy(U3RXOutputBuffer, U3RXinputBuffer); 
        strcpy(U3RXOutputBuffer, U3RXinputBuffer); 
           //copy input buffer to output buffer
       // memset(U3RXinputBuffer, 0, 128);
