...
/**
  ...
  @Example
    ...
    // Read RA3
    postValue = PTT_GetValue();
    </code>

 */
#define PTT_GetValue()         _RA3
/**
  @Summary
 ...
 */
#define PTT_SetDigitalInput()  _TRISA3 = 1
/**
  @Summary
  ...
  @Example
    ...
    PTT_SetDigitalOutput();
    </code>

 */
#define PTT_SetDigitalOutput() _TRISA3 = 0
/**
  @Summary
  ...
  @Example
    ...
    // Read RA4
    postValue = Input1_GetValue();
    </code>

 */
#define Input1_GetValue()         _RA4
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RB5
    postValue = MUTE_GetValue();
    </code>

 */
#define MUTE_GetValue()         _RB5
/**
  @Summary
  ...
  @Example
    ...
    MUTE_SetDigitalInput();
    </code>

 */
#define MUTE_SetDigitalInput()  _TRISB5 = 1
/**
  @Summary
  ...
  @Example
    ...
    MUTE_SetDigitalOutput();
    </code>

 */
#define MUTE_SetDigitalOutput() _TRISB5 = 0
/**
  @Summary
 ...
 */
#define U1RX_SetDigitalInput()  _TRISB7 = 1
/**
  @Summary
 ...
 */
#define U1RX_SetDigitalOutput() _TRISB7 = 0
/**
  @Summary
 ...
 */
#define U1TX_SetDigitalInput()  _TRISB8 = 1
/**
  @Summary
 ...
 */
#define U1TX_SetDigitalOutput() _TRISB8 = 0
/**
  @Summary
 ...
 */
#define U3TX_SetDigitalInput()  _TRISB9 = 1
/**
  @Summary
 ...
 */
#define U3TX_SetDigitalOutput() _TRISB9 = 0
/**
  @Summary
 ...
 */
#define U2TX_SetDigitalInput()  _TRISB10 = 1
/**
  @Summary
 ...
 */
#define U2TX_SetDigitalOutput() _TRISB10 = 0
/**
  @Summary
 ...
 */
#define U2RX_SetDigitalInput()  _TRISB11 = 1
/**
  @Summary
 ...
 */
#define U2RX_SetDigitalOutput() _TRISB11 = 0
/**
  @Summary
 ...
 */
#define TUNING_SetHigh()          _LATB13 = 1
/**
  @Summary
 ...
 */
#define TUNING_SetLow()           _LATB13 = 0
/**
  @Summary
 ...
 */
#define TUNING_Toggle()           _LATB13 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB13
    postValue = TUNING_GetValue();
    </code>

 */
#define TUNING_GetValue()         _RB13
/**
  @Summary
  ...
  @Example
    ...
    TUNING_SetDigitalInput();
    </code>

 */
#define TUNING_SetDigitalInput()  _TRISB13 = 1
/**
  @Summary
  ...
  @Example
    ...
    TUNING_SetDigitalOutput();
    </code>

 */
#define TUNING_SetDigitalOutput() _TRISB13 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Set RB15 high (1)
    HeartbeatLED_SetHigh();
    </code>

 */
#define HeartbeatLED_SetHigh()          _LATB15 = 1
/**
  @Summary
 ...
 */
#define HeartbeatLED_SetLow()           _LATB15 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RB15
    HeartbeatLED_SetToggle();
    </code>

 */
#define HeartbeatLED_Toggle()           _LATB15 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB15
    postValue = HeartbeatLED_GetValue();
    </code>

 */
#define HeartbeatLED_GetValue()         _RB15
/**
  @Summary
  ...
  @Example
    ...
    HeartbeatLED_SetDigitalInput();
    </code>

 */
#define HeartbeatLED_SetDigitalInput()  _TRISB15 = 1
/**
  @Summary
  ...
  @Example
    ...
    HeartbeatLED_SetDigitalOutput();
    </code>

 */
#define HeartbeatLED_SetDigitalOutput() _TRISB15 = 0
